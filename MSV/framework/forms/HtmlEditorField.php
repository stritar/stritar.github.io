	...
	protected function getFieldsForOembed($url, $file) {
		...
		$fields = new FieldList(
			...
			DropdownField::create(
				...
				array(
					'img-responsive' => _t('HtmlEditorField.CSSCLASSLEFTALONE', 'On the left, on its own.'),
					'img-responsive text-center center' => _t('HtmlEditorField.CSSCLASSCENTER', 'Centered, on its own.'),
					'img-responsive pull-left left' => _t('HtmlEditorField.CSSCLASSLEFT', 'On the left, with text wrapping around.'),
					'img-responsive pull-right right' => _t('HtmlEditorField.CSSCLASSRIGHT', 'On the right, with text wrapping around.')
				)
			)->addExtraClass('last')
		);
